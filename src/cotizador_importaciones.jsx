...
// ── Registro de IDs de clientes ──────────────────────────────────────────────
// Al agregar un cliente nuevo, añadir aquí su entrada con el próximo CLI-XXX
const CLIENTE_IDS = {
  "Brian":             "CLI-001",
                          ...
                          <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
                            {clientesUnicos.map(cl=>(
                              <button key={cl} onClick={()=>setForm(p=>({...p,cliente:cl,categoria_cliente:cotizaciones.filter(c=>c.cliente===cl).slice(-1)[0]?.categoria_cliente||p.categoria_cliente}))}
                                ...
                                {cl}{CLIENTE_IDS[cl]?` · ${CLIENTE_IDS[cl]}`:""}
                              </button>
                            ))}
                    ...
                    return(
                      <div key={cl} onClick={()=>setClienteSeleccionado(sel?null:cl)} style={{background:sel?"#22c55e18":"#0c1a2e",border:`1px solid ${sel?"#22c55e55":"#1a2d45"}`,borderRadius:10,padding:"12px 14px",cursor:"pointer",transition:"all .15s"}}>
                        <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:4}}>
                          <span style={{fontWeight:700,fontSize:13,color:sel?"#1aa358":"#dce8f0"}}>👤 {cl}</span>
                          {CLIENTE_IDS[cl]&&<span style={{fontSize:10,fontWeight:700,color:"#c9a055",background:"#c9a05518",border:"1px solid #c9a05533",borderRadius:20,padding:"1px 7px",letterSpacing:.5}}>{CLIENTE_IDS[cl]}</span>}
                        </div>
                        <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
              ...
              {clienteSeleccionado&&(
                <div>
                  <div style={{display:"flex",gap:8,marginBottom:16,flexWrap:"wrap",alignItems:"center"}}>
                    <div style={{fontWeight:800,fontSize:18,color:"#dce8f0",flex:1,display:"flex",alignItems:"center",gap:10}}>
                      👤 {clienteSeleccionado}
                      {CLIENTE_IDS[clienteSeleccionado]&&<span style={{fontSize:12,fontWeight:700,color:"#c9a055",background:"#c9a05518",border:"1px solid #c9a05533",borderRadius:20,padding:"2px 10px",letterSpacing:.5}}>{CLIENTE_IDS[clienteSeleccionado]}</span>}
                    </div>
